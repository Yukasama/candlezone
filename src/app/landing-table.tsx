...
// import { getLandingTableColumns } from "@/config/landing-table";
...
//       <TableHeader>
//         {getLandingTableColumns([]).map((column) => (
//           <TableColumn key={column.accessorKey} className="text-sm">
//             {column.header}
//           </TableColumn>
//         ))}
//       </TableHeader>
//       <TableBody className="bg-transparent" emptyContent={"No stocks found"}>
