...
export const generateCspHeader = ({ nonce }: { nonce: string }) => {
  return `
    ...
    img-src 'self' blob: data: https://lh3.googleusercontent.com https://scontent-frt3-2.xx.fbcdn.net https://avatars.githubusercontent.com https://financialmodelingprep.com https://wsrv.nl http://purecatamphetamine.github.io;
    font-src 'self';
    object-src 'none';
    base-uri 'self';
    form-action 'self';
