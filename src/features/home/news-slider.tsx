...
import { ChevronUp, RotateCcw, TriangleAlert } from 'lucide-react';
...
export const NewsSlider = () => {
  ...
  return (
    <Drawer>
      <DrawerTrigger asChild className="fixed bottom-1 left-[43%]">
        <div className="bg-faded/70 flex flex-col items-center gap-1 rounded-2xl p-3">
          <Button className="size-9" size="icon" variant="secondary">
            <ChevronUp className="size-5" />
          </Button>
          <p className="text-desc text-sm">Show current news</p>
        </div>
      </DrawerTrigger>
      <DrawerContent>
        <DrawerTitle className="sr-only">Current News</DrawerTitle>
        <Carousel className="p-10">
          <CarouselContent className="h-[105px] sm:h-[500px]">
