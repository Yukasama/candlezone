...
import { verify2fa as verify2faFn } from './actions/2fa/verify';
...
export const TwoFactorModal = () => {
  ...
  return (
    <>
      ...
      <ResponsiveDialog open={open} setOpen={setOpen} title="Verify 2FA">
        <div className="flex w-full justify-end">
          <div className="container mx-auto p-4">
            <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4">
              <div className="flex flex-1 items-center justify-center rounded-md p-4 text-white">
              ...
              <form
                className="flex-1 rounded-md p-4 text-white"
                onSubmit={onSubmit}
              >
                <p className="mb-4 text-2xl font-bold text-gray-700">
                  Use an Authenticator App to enable 2FA
                </p>
                <ul className="mb-4 list-inside list-none text-gray-700">
                  <li className="mb-2">
